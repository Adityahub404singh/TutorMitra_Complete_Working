...
<Route path="/about" element={<AboutPage />} />
                ...
                />
                <Route
  path="/trial-booking/:courseId"
  element={
    <PrivateRoute allowedRoles={["student"]}>
      <TrialBookingPage
        price={0} // Ya jo price chahiye pass karo
        bookingTypes={[
          { value: "trial", label: "Trial (Low Cost, 3 days)" }
          // aur bhi types add kar sakte ho future me
        ]}
