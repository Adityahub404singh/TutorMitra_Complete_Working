...
import { useAuth } from "../store/AuthProvider"; // Adjust path if needed
...
export default function Courses() {
  ...
  function handleBookNow(course: Course) {
    if (authLoading) return; // Wait for auth state ready
    if (!user) {
    ...
    if (user.role !== "student") {
      alert("Only students can book sessions. Please log in as a student.");
      return;
    }
    if (!course.instructor || !course.instructor._id) {
      alert("Booking unavailable for this course: Instructor info missing.");
      return;
    }
    // Navigate to tutor profile page where booking is handled
    navigate(`/tutors/${course.instructor._id}`);
  }
            ...
            >
              ...
              <div className="relative flex items-center mb-3">
                <div className="relative">
                  ...
                  />
                  <span className="pointer-events-none absolute left-0 top-2 w-full h-2 rounded-full opacity-20 bg-white blur-[1.5px]" />
                </div>
                ...
                <div className="w-full flex justify-between items-center">
                  ...
                  <button
                    ...
                    style={{
                      ...
                      boxShadow: "0 6px 40px -6px #be2afc11, 0 2px 8px 0 #fff9c022",
                    }}
                  >
