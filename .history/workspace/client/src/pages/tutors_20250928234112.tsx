...
function getAvatarUrl(profileImage: string | undefined, name: string): string {
  if (!profileImage)
...
export default function Tutors() {
  ...
  const tutorsToShow = filteredTutors.slice(0, page * TUTORS_PER_PAGE);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white p-8 max-w-7xl mx-auto flex flex-col items-center">
      ...
      {tutorsToShow.length < filteredTutors.length && (
        <button
          className="mt-8 px-6 py-2 rounded-xl bg-indigo-700 hover:bg-indigo-800 text-white font-semibold"
