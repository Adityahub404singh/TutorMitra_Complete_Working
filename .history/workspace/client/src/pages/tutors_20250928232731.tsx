...
import { Navigation, Pagination } from "swiper"; // Correct import for modules
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-gradient-to-br from-indigo-50 via-blue-50 to-white p-8 max-w-7xl mx-auto flex flex-col items-center">
      <header className="mb-10 text-center max-w-2xl">
        <h1 className="text-4xl font-extrabold text-indigo-900 tracking-wide drop-shadow-md mb-4">
      ...
      <section className="mt-20 bg-indigo-900 text-white rounded-3xl p-12 max-w-5xl shadow-lg text-center select-none">
        ...
        <p className="mb-6 max-w-xl mx-auto">
          TutorMitra connects you with verified offline tutors offering personalized coaching in your city.
          Easy bookings, transparent pricing and trial classes make learning simple and trustworthy.
        </p>
        <ul className="list-disc list-inside max-w-md mx-auto space-y-2">
          <li>Verified and experienced tutors.</li>
          <li>No hidden charges, clear pricing.</li>
          <li>Simple and quick trial bookings.</li>
          <li>Personalized coaching and support.</li>
