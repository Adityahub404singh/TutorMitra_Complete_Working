...
export default function Courses() {
  ...
  // Responsive swiper breakpoint config
      ...
      <header className="w-full bg-gradient-to-r from-teal-800 via-cyan-600 to-blue-600 text-white shadow-md">
        <div className="max-w-7xl px-6 mx-auto text-center pt-10 pb-8 rounded-b-3xl">
          ...
          <div className="text-sky-100/90 font-medium max-w-2xl mx-auto mb-2">
            Browse verified tutors for in-person & online coaching, compare profiles, book trial sessions, and learn anything!
          </div>
          <div className="text-base text-cyan-50 italic">Scroll below and use <b>"Load More"</b> to see more experts.</div>
        </div>
      </header>
          ...
          {displayedCourses.length < courses.length && (
            <div className="flex justify-center mt-4 md:mt-8">
              <button
                ...
                className="px-7 py-3 bg-emerald-700 hover:bg-emerald-900 rounded-full shadow text-white font-bold tracking-wide text-lg transition"
              >
                Load More Tutors
              </button>
            </div>
