...
import { Navigation, Pagination } from "swiper/mod;
import "swiper/css";
      ...
      {featuredCourses.length > 0 && (
        <div className="max-w-7xl mx-auto mb-12">
          <Swiper
            ...
            key={featuredCourses.length} // to refresh slider on updates
          >
            {featuredCourses.map((course) => (
              <SwiperSlide key={course._id}>
                <article className="bg-white shadow-lg border border-gray-200 rounded-xl p-5 flex flex-col h-full">
                  ...
                  <h2 className="text-xl font-bold text-blue-900 mb-2 truncate">{course.title}</h2>
                  <p className="text-blue-800 font-semibold mb-1 truncate">
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    ...
                    <button
                      ...
                      className="py-2 px-4 rounded-full bg-indigo-600 text-white font-semibold shadow hover:bg-indigo-700 transition duration-300"
                    >
                      Book Now
                    </button>
                  </div>
