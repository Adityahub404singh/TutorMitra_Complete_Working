...
export default function Tutors() {
  ...
  // filtered tutors based on location and subject
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-gradient-to-br from-indigo-50 via-blue-50 to-white p-8 max-w-7xl mx-auto flex flex-col items-center">
      <header className="mb-10 text-center max-w-2xl">
        <h1 className="text-4xl font-extrabold text-indigo-900 tracking-wide drop-shadow-md mb-2">
          Discover Skilled Tutors Easily
        </h1>
        <p className="text-indigo-700 text-lg leading-relaxed select-none">
          Explore multiple expert tutors from nearby your city with trial and booking options at your fingertips.
        </p>
      </header>

      {/* Swiper slider displaying tutor cards */}
      <Swiper
        spaceBetween={30}
        slidesPerView={1}
      ...
      <section className="mt-24 bg-indigo-900 text-white p-12 rounded-3xl max-w-5xl text-center select-none shadow-lg">
        <h2 className="text-3xl font-semibold mb-6">Why TutorMitra is Different?</h2>
        <p className="max-w-3xl mx-auto mb-6 text-lg leading-relaxed">
          TutorMitra focuses on connecting students directly with trustworthy offline tutors offering personalized coaching and flexible trials.
        </p>
        <ul className="list-disc list-inside text-left max-w-md mx-auto space-y-2 text-md font-medium">
          <li>Verified tutors with proven teaching skills</li>
          <li>No hidden fees, transparent pricing</li>
          <li>Easy booking with instant trial classes</li>
          <li>Personalized learning based on your needs</li>
          <li>Community support and reliable communication</li>
        </ul>
      </section>
    </div>
  );
