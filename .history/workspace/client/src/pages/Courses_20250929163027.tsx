...
export default function MotivationalCoursesPage() {
  ...
  // Show max 6 courses in slider for smooth sliding
  const sliderCourses = courses.slice(0, PAGE_SIZE);
  // Remaining courses show below in grid
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-cyan-100 via-indigo-50 to-blue-200 px-4 py-7">
      <section className="max-w-5xl mx-auto text-center mb-12">
        ...
        <p className="text-base text-gray-500 italic max-w-2xl mx-auto tracking-tight">
          Every step you take builds the future. With TutorMitra’s verified experts,
          your success is just one lesson away.
        </p>
      </section>
      ...
      <main className="flex-grow max-w-7xl mx-auto">
        ...
        <Swiper
          breakpoints={{
            ...
            1024: { slidesPerView: 6, spaceBetween: 24 }, // 6 slides max on large screen
          }}
          navigation
            ...
            <SwiperSlide key={course._id}>
              ...
              >
                ...
                <div className="flex gap-2 mb-4">
                  <span
                    className={`uppercase text-xs font-bold px-4 py-1 rounded-full ${BADGE_COLORS[course.coachingType]}`}
