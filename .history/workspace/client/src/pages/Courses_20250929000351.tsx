        ...
        >
          {courses.map((course) => (
            <SwiperSlide key={course._id} className="w-[320px] flex justify-center">
              <div className="flex flex-col rounded-xl bg-white shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-shadow duration-300 w-full">
                {/* Tutor Image with shadow */}
                ...
                <div className="flex flex-wrap items-center gap-2 mb-3">
                  <span
                    className={`text-xs font-bold uppercase px-3 py-1 rounded-full ${BADGE_COLORS[course.coachingType] || "bg-gray-400 text-white"}`}
                  >
                    {course.coachingType}
                  </span>
