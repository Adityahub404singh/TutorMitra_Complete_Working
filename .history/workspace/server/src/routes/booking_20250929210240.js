// File path: /server/routes/booking.js

import express from "express";
import Booking from "../models/Booing.js";
...
// CREATE booking (trial or normal booking)
router.post("/", authenticate, async (req, res) => {
  try {
    ...
    // Determine booking amount based on trial and course price
    let amount;
    if (isTrial) {
